    ...
    <div class="content-header">
        ...
        <div class="content-header-right">
            <div class="data-bulk-action" aria-name="bulk-action" action-type="button-updater">
                <select one id="data-bulk-options">
        ...
        <div class="row" aria-name="tab">
            <div class="col col-left">
                <ul aria-name="tabs" class="vertical-tabs" tab-name="main">
                    <li data-tab="user-access-role" class="active"><i class="fa-solid fa-user-unlock"></i> User Access Role
                    </li>
            ...
            <div class="col col-right" style="overflow-y: overlay;">
                                ...
                                <div class="buttons inline">
                                    ...
                                    <script>
                                        document.getElementById("update-user-access").addEventListener("click", function() {
                                            // document.getElementById("update-user-access-form").submit();
                                            selectMedia();
                                        });
                                    </script>
                                </div>
                    ...
                    <div class="tab-data-container" data-tab="member-role">
                        <div class="tab-data-wrap" aria-name="data-wrapper">
                            <div class="tab-container-heading">
                                <h2></h2>
                                <div class="buttons inline">
                                    <button class="btn" name="add-dbdata"><i class="fas fa-plus"></i> Add
                                        Data</button>
                                    <button class="btn primary filled" id="update-member-role"> <i
                                            class="fa-solid fa-rotate right"></i> Update</button>
                                </div>
                            </div>
                            <div class="data-content">
                                <table class="data-table last-child-action" id="table" aria-name="qdata">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td drag><input type="checkbox" value="0000" name="select-individual-data">
                                            </td>
                                            <td>
                                                <div class="field"><input type="text" name="query-value"
                                                        placeholder="query-value" disabled required /></div>
                                            </td>
                                            <td>
                                                <div class="fields inline">
                                                    <div class="field"><input type="text" name="data-en"
                                                            placeholder="English" required /></div>
                                                    <div class="field"><input type="text" name="data-bn"
                                                            placeholder="বাংলা" /></div>
                                                </div>
                                            </td>
                                            <td>
                                                <button class="delete btn only-icon" name="delete"><i
                        ...
                        <div class="tab-data-wrap" aria-name="data-wrapper">
                            <div class="tab-container-heading">
                                ...
                                <div class="buttons inline">
                                    <button  class="btn" name="add-dbdata"><i class="fas fa-plus"></i> Add
                                        Data</button>
                                    <button onclick="handleSubmitAddress()" class="btn primary filled" id="update-addresses"> <i
                                            class="fa-solid fa-rotate right"></i> Update</button>
                                </div>
                                <div class="fields inline">
                                    <div class="field"><select one id="division">
                                            <option value="">বিভাগ</option>
                                        </select></div>
                                    <div class="field"><select one id="district">
                                            <option value="">জেলা</option><select></div>
                                    <div class="field"><select one id="upzilla">
                                            <option value="">উপজেলা/থানা</option>
                                        </select></div>
                                    <div class="field"><select one id="union">
                                            <option value="">ইউনিয়ন</option>
                                        </select></div>
                                    <div class="field"><select one id="ward">
                                ...
                                <table class="data-table last-child-action" id="table" aria-name="qdata">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="field"><input type="text" name="query-value"
                                                        placeholder="query-value" value="dhaka" disabled required />
                                                </div>
                                            </td>
                                            <td>
                                                <div class="fields inline">
                                                    <div class="field"><input type="text" name="data-en"
                                                            placeholder="English" value="Dhaka" required></div>
                                                    <div class="field"><input type="text" name="data-bn"
                                                            placeholder="বাংলা" value="ঢাকা"></div>
                                                </div>
                                            </td>
                                            <td>
                                                <button class="delete btn only-icon" name="delete"><i
                        ...
                        <div class="tab-data-wrap" aria-name="data-wrapper">
                            <div class="tab-container-heading">
                                ...
                                <div class="buttons inline">
                                    <button class="btn" name="add-dbdata"><i class="fas fa-plus"></i> Add
                                        Data</button>
                                    <button class="btn primary filled" id="update-committee-types"> <i
                                            class="fa-solid fa-rotate right"></i> Update</button>
                                </div>
                            </div>
                            <div class="data-content">
                                <table class="data-table last-child-action" id="table" aria-name="qdata">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="delete btn only-icon" name="delete"><i
                                                        class="fa-solid fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    </tbody>
                        ...
                        <div class="tab-data-wrap" aria-name="data-wrapper">
                            <div class="tab-container-heading">
                                ...
                                <div class="buttons inline">
                                    <button class="btn" name="add-dbdata"><i class="fas fa-plus"></i> Add
                                        Data</button>
                                    <button class="btn primary filled" id="update-wing-types"> <i
                                            class="fa-solid fa-rotate right"></i> Update</button>
                                </div>
                            </div>
                            <div class="data-content">
...
<script>
    function selectMedia() {
        var user_access_tr = $('.user-access_tr');
        var serializedData = {};

        user_access_tr.each(function() {
            var inputValue = $(this).find('input').val();
            var checkbox = $(this).find('input[type="checkbox"]');
            serializedData[inputValue] = [];

            console.log("Input Value:", inputValue); // Logging input value
            ...
            checkbox.each(function() {
                ...
                console.log("Checkbox Value:", checkboxValue); // Logging checkbox value
                console.log("Is Checked:", isChecked); // Logging checkbox isChecked value
            });
        });

        $.ajax({
            type: "POST",
            url: "{{ route('frequent.update') }}",
            data: {
                _token: "{{ csrf_token() }}",
