...
<div class="content-header">
    ...
    <div class="content-header-right">
        ...
        <div class="add-data">
            <a class="btn" href="{{ url('add_new_post') }}"> <i class="fa-regular fa-file-lines right"></i> <span data-i18n="post.new"></span></a>
        </div>
    </div>
    <div class="data-filter buttoned-filter">
        <div class="data-filter">
            ...
            <select one id="filter-category" place-i18n="post.category"><option value=""></option></select>
        </div>
...
<script>
    const filter_category = Choice(document.getElementById('filter-category'), [
